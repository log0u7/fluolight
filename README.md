...
A dedicated CI/CD status server (`server/pipeline_server.py`) is available
...
- I2C_EEPROM
- Adafruit NeoPixel
- TimedAction (installed automatically by `make compile` via `arduino-cli lib install --git-url`)
